//
//  SpriteKit_SKScene_InfoView.swift
//  DevLab
//
...
struct SpriteKit_SKScene_InfoView: View {
    ...
    private func loadMarkdownFile(filename: String = "SpriteKit_SKScene_Demo", fileType type: String = "md") {
