//
//  SwiftUI_TextField_InfoView.swift
//  DevLab
//
...
struct SwiftUI_TextField_InfoView: View {
    ...
    private func loadMarkdownFile(filename: String = "SwiftUI_TextField_Demo", fileType type: String = "md") {
