//
//  SwiftUI_DatePicker_InfoView.swift
//  DevLab
//
...
struct SwiftUI_DatePicker_InfoView: View {
    ...
    private func loadMarkdownFile(filename: String = "SwiftUI_DatePicker_Demo", fileType type: String = "md") {
