//
//  AppKit_NSButton_InfoView.swift
//  DevLab
//
...
struct AppKit_NSButton_InfoView: View {
    ...
    private func loadMarkdownFile(filename: String = "AppKit_NSButton_Demo", fileType type: String = "md") {
